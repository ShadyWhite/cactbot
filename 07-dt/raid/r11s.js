...
const ultimateTrophyWeaponsMap = [
  undefined,
  undefined,
  {
    delay: 0,
  ...
  triggers: [
    ...
    },
    {
      ...
      infoText: (data, matches, output) => {
        ...
        const portalDirNum = Directions.xyTo4DirIntercardNum(actor.x, actor.y, center.y, center.x);
    ...
    },
    {
      ...
      promise: async (data) => {
        ...
        if (combatants.length !== 1 || me === undefined) {
          console.error(`R11S Explosion Towers: Wrong combatants count ${combatants.length}`);
          return;
        }
